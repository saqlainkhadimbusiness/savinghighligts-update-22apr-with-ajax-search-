            ...
            <div class="login-area">
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="{{url('/registerit')}}" id="loginForm" method="post"> {{csrf_field()}}
                            <div class="form-group">
                                <label class="control-label" for="username">Username</label>
                                <input type="text" placeholder="example@gmail.com" title="Please enter you username" required="" value="" name="username" id="name" class="form-control">
