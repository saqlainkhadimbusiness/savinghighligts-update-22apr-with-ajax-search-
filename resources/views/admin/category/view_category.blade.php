             ...
             <div class="panel panel-bd lobidrag">
                ...
                <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                   <div class="btn-group">
                      ...
                      <a class="btn btn-add" href="{{url('/showcat')}}"> <i class="fa fa-plus"></i> Add  Categories
                         </a>
                      </div>
                         ...
                         <tbody>
                            ...
                            <td>
                              ...
                              <div id="myElem" style="display:none;" class="alert alert-success">Status Enabled</div>
                               ...
                               <a href="{{url('deletecategory/'.$category->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> </button>
                               </td>
                            </tr>
                             @endforeach
                         </tbody>
