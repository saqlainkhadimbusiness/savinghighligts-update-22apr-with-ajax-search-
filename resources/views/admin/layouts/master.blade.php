...
{{-- devlopermood-header --}}
<?php
$abc=App\Models\editheader::where(['id' => 1])->get();
print_r($abc[0]->description);
?>
...
<script>
    ...
    $('.select_store_select2').select2({
      ajax: {
        url: 'http://www.refundcode.com/functions/Taxonomies_controller/select2searchTaxonomies',
        dataType: 'json',
        method: 'POST',
        data: function (params) {
          var query = {
            search_query: params.term,
            taxonomy_type: $(this).attr('data-taxonomy'),
            _token : '17a008bcbac0ab6b8f512187e93b8d09'
          }
          return query;
        },
  ...
  <script src="http://www.refundcode.com/assets/control_panel/js/sortable.js"></script>
  ...
  <script src="http://www.refundcode.com/assets/control_panel/js/custom.js"></script>
  </body>
  </html>
...
{{-- developermood-footer --}}
<?php
$abc=\App\Models\editfooter::where(['id' => 1])->get();
print_r($abc[0]->description);
?>
