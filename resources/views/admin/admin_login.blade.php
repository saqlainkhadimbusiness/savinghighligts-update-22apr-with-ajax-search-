    ...
    <body>
        ...
        <div class="login-wrapper">
            <div class="container-center">
                    ...
                    <div class="alert alert alert-success alert-block" role="alert">
            ...
            <div class="login-area">
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="/login" id="loginForm" method="post"> {{csrf_field()}}
                            <div class="form-group">
                                <label class="control-label" for="username">Email</label>
                                <input type="email" placeholder="example@gmail.com" title="Please enter you email" required="" value="" name="email" id="username" class="form-control">
                            ...
                            <div>
                                ...
                                {{-- <a class="btn btn-warning" href="/register2">Register</a> --}}
                            </div>
                        </form>
                        </div>
                        </div>
